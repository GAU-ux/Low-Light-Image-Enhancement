...
parser.add_argument('--data_test', type=str, default='./testing_MEF/MEF')
parser.add_argument('--model', default='weights/epoch_3000.pth', help='Pretrained base model')  
parser.add_argument('--output_folder', type=str, default='./testing_MEF/MEF_Result')
...
def eval():
    ...
    for batch in testing_data_loader:
        ...
        # L_img.save(opt.output_folder + '/' + name[0])
        # R_img.save(opt.output_folder + '/' + name[0])
        I_img.save(opt.output_folder + '/' + name[0])  
        # D_img.save(opt.output_folder + '/' + name[0])                       
